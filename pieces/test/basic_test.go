...
func ExampleMyStruct() {
	...
	//output:MyStruct a=test.MyStruct a=<MyStruct>(1,1)
	//MyStruct b=test.MyStruct b=<MyStruct>(1,1)
...
func (i *IpAddr) String() string {
	r := fmt.Sprintf("%v.%v.%v.%v", i[0], i[1], i[2], i[3])
	return r
}

func (i IpAddr) String2() string {
	r := fmt.Sprintf("%v.%v.%v.%v", i[0], i[1], i[2], i[3])
	return r
}
