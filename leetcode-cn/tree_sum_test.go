...
func TestThreeSum(t *testing.T) {
	...
	b := threeSum(a)
	t.Logf("len = %v", len(b))
	assert.Equal(t, len(b), 16258)

}

func TestThreeSum2(t *testing.T) {

	a := []int{-1, -2, -3, 4, 1, 3, 0, 3, -2, 1, -2, 2, -1, 1, -5, 4, -3,}

	b := threeSum(a)

	t.Logf("len= %v", len(b))
	//t.Log(b)
	assert.Equal(t, len(b), 11)
...
func TestThreeSum7(t *testing.T) {

	a := []int{-4, -1, -4, 0, 2, -2, -4, -3, 2, -3, 2, 3, 3, -4}
	b := threeSum(a)
